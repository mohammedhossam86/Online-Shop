...
const { getProduct, redirectHome , getAddProducts ,getProvidersProducts , postProducts , getProductImage} = require('../controllers/productsController');
...
router.post('/', authMiddleWare , allowRoles('provider'), uploadImage.single('image'), postProducts);
